...
<a class="hover:text-neon-green transition-colors" href="#">Tactical Grid</a>
<a class="hover:text-neon-green transition-colors" href="#">Neural Assets</a>
<a class="hover:text-neon-green transition-colors" href="#">Protocol Log</a>
</div>
<div class="flex items-center gap-4">
<span class="text-[10px] font-mono text-neon-green hidden sm:inline-block">STATUS: ONLINE // UNIT-01</span>
<button class="bg-primary text-white px-6 py-2 rounded-sm font-bold text-xs tracking-widest uppercase glow-primary hover:scale-105 transition-transform">
                    DEPLOY
                </button>
</div>
</div>
...
<button class="group relative px-10 py-5 bg-primary overflow-hidden rounded-sm transition-all hover:pr-12 glow-primary">
...
<button class="px-10 py-5 border border-white/20 hover:border-neon-green transition-colors text-white font-bold text-sm tracking-[0.2em] uppercase rounded-sm bg-white/5">
                    Interface Demo
                </button>
</div>
</div>
<!-- System Stats Bar -->
<div class="mt-24 grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-6xl px-4">
<div class="bg-eva-purple/20 border-l-2 border-neon-green p-6 backdrop-blur-sm">
<p class="text-[10px] font-bold text-neon-green tracking-widest uppercase mb-1">Throughput</p>
<h3 class="text-3xl font-bold">400%</h3>
<p class="text-[10px] text-gray-500 font-mono mt-2">SYNC_SUCCESS: 100%</p>
</div>
<div class="bg-eva-purple/20 border-l-2 border-primary p-6 backdrop-blur-sm">
<p class="text-[10px] font-bold text-primary tracking-widest uppercase mb-1">Uptime</p>
<h3 class="text-3xl font-bold">99.9%</h3>
<p class="text-[10px] text-gray-500 font-mono mt-2">SERVER_LNK: STABLE</p>
</div>
<div class="bg-eva-purple/20 border-l-2 border-neon-green p-6 backdrop-blur-sm">
<p class="text-[10px] font-bold text-neon-green tracking-widest uppercase mb-1">Security</p>
<h3 class="text-3xl font-bold">PRO-09</h3>
<p class="text-[10px] text-gray-500 font-mono mt-2">ENCR_LVL: MAX</p>
</div>
<div class="bg-eva-purple/20 border-l-2 border-white p-6 backdrop-blur-sm">
<p class="text-[10px] font-bold text-white tracking-widest uppercase mb-1">Grid Sync</p>
<h3 class="text-3xl font-bold">ACTIVE</h3>
<p class="text-[10px] text-gray-500 font-mono mt-2">LATENCY: 0.02ms</p>
</div>
</div>
</section>
<!-- Features Section -->
...
<button class="bg-primary text-white px-12 py-5 rounded-sm font-bold text-sm tracking-[0.3em] uppercase glow-primary hover:scale-105 transition-all">
                        SYSTEM START
                    </button>
<button class="bg-neon-green/10 text-neon-green border border-neon-green/30 px-12 py-5 rounded-sm font-bold text-sm tracking-[0.3em] uppercase hover:bg-neon-green/20 transition-all">
                        Request Intel
                    </button>
</div>
</div>
